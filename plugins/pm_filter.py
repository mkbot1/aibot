...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('നിങ്ങൾ ഉദ്ദേശിച്ച സിനിമ ഇതിൽ ഉണ്ടോ എന്ന നോക്കൂ... 𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴 💌')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝘚𝘖𝘕𝘎', callback_data='songs'),
            ...
            InlineKeyboardButton('𝘈𝘜𝘋𝘐𝘖-𝘉𝘖𝘖𝘒', callback_data='abook'),
            InlineKeyboardButton('𝘗𝘐𝘕𝘎', callback_data='pings')
            ],[
            InlineKeyboardButton('𝘎-𝘛𝘙𝘈𝘕𝘚', callback_data='gtrans'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"𝙋𝘼𝙂𝙀 1/{round(int(total_results) / 10)}", callback_data="pages"),
