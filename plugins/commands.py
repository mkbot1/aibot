...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        m=await message.reply_text("CAACAgUAAxkBAAEBB2liJjsNVSkfAy_OtYR0Q48dN_9DsAACGgIAAv68YVTI6jnmvnlZlh4E") 
        await asyncio.sleep(1)
        await m.delete()
        await message.reply_chat_action("typing")
        m=await message.reply_text("CAACAgUAAxkBAAEBB35iJjxD1GtQSZLiEpZ6jy6De4ilEQACxQQAAlwPSFVIEFIJTgeDTB4E") 
        await asyncio.sleep(1)
        await m.delete()          
        reply_markup = InlineKeyboardMarkup(buttons)        
